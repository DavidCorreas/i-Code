PYTHONPATH="." CUDA_VISIBLE_DEVICES=1 python benchmarker/cli/l5/train.py \
--gpus 1 \
--model_name_or_path "/workspaces/udop/i-Code-Doc/benchmarker/model/DocVQA-T5-large-2D-U" \
--relative_bias_args '[{"type":"1d"},{"type":"horizontal"},{"type":"vertical"}]' \
--model_type 'UdopUnimodel' \
--data_dir '/workspaces/udop/due-benchmark/raw_data/' \
...
--im_dir '/workspaces/udop/due-benchmark/raw_data/pdf/DocVQA' \
...
--output_dir './results/results_docvqa_224-t5-2d-u' \
--warmup_steps 100 \
--learning_rate 5e-5 \
